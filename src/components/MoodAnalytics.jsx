        ...
        {weekData.map((day, index) => {
          ...
          return (
            <div key={index} className="text-center">
              <div className="text-xs text-blue-900 mb-1">{day.day}</div>
              <div
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <div className="card">
            <h3 className="text-xl font-semibold text-blue-900 mb-6">Weekly Overview</h3>
            {renderWeeklyCalendar()}
            
            <div className="mt-6 p-4 bg-calm-50 rounded-lg">
              <div className="flex items-center justify-between text-sm">
                <span className="text-blue-900">Legend:</span>
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-1">
                    <div className="w-3 h-3 bg-primary-400 rounded"></div>
                    <span className="text-blue-900">Exercises completed</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="space-y-6">
          <div className="card">
            <h3 className="text-xl font-semibold text-blue-900 mb-6">Key Insights</h3>
            <div className="space-y-4">
                ...
                >
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-blue-900">{insight.description}</p>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
        <div className="card">
          <h3 className="text-xl font-semibold text-blue-900 mb-6">Mood Distribution</h3>
          {renderMoodChart()}
        </div>

        {/* Progress Summary */}
        <div className="card">
          <h3 className="text-xl font-semibold text-blue-900 mb-6">Progress Summary</h3>
          <div className="space-y-4">
